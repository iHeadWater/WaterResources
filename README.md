...
4. 学习python编程的[hydrus](https://github.com/waterDLut/hydrus)，和学习深度学习基本概念的[hydro-dl-basic](https://github.com/waterDLut/hydro-dl-basic)，后续根据[学习小组](https://github.com/waterDLut)实际推进情况逐步更新。  
5. 科研随笔：记录科研方式方法等一些比较个人经验化的内容，分享对学习、研究中面临的各类问题的看法、想法，*仍在开发中*，可查看[这里](https://github.com/waterDLut/WaterResources/tree/master/notes)；
